...
class SearchAPITest:
    ...
    def run_semantic_search_success_test(self):
        try:
            request_body = SEARCH_REQUEST_BODY
            request_body['search_type'] = 'semantic_search'
    ...
    def run_normal_search_success_test(self):
        try:
            request_body = SEARCH_REQUEST_BODY
            request_body['search_type'] = 'normal_search'
            response = post_search(SEARCH_REQUEST_BODY, PROJECT_API_TOKEN, count=self.count)
        except Exception as e:
            print(f"Error in run_search_success_test: {e}")
            return
...
def main():
    ...
    search_test.run_normal_search_success_test()
    search_test.run_semantic_search_success_test()
